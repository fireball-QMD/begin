...
! Initialize some constants
        ...
        write (*,*) '  '
!-------jesus.JOM in the case of nexcite=3 we make sure we use the pp used for the GS 
!         (ppfile not ppfileion)


          call pp (ppfile, mesh_rcatms, r, vc, vl, ioptionpp, exmix)
!------------------	
...
! Write out the information to the files
        ...
        do issh = 0, nssh
         write (*,100) filename_na(issh)
         open (unit = 66, file = filename_na(issh),  status = 'unknown')
