...
! Write out the information to the files
        ...
        do issh = 1, nssh
         ...
         open (unit = 66, file = filename_ena(issh),  status = 'unknown')
...
! For plotting purposes
         l = lam(issh)
!dani         if (l .eq. 0) open (unit = 47, file = 'NAe_splot', status = 'unknown')
!dani         if (l .eq. 1) open (unit = 47, file = 'NAe_pplot', status = 'unknown')
!dani         if (l .eq. 2) open (unit = 47, file = 'NAe_dplot', status = 'unknown')
!dani         if (l .eq. 3) open (unit = 47, file = 'NAe_fplot', status = 'unknown')
!dani         do ipoint = 1, nrr
!dani          write (47,301) xrr(ipoint), vvrho(issh,ipoint)
!dani         end do
!dani         close (unit = 47)
        end do
