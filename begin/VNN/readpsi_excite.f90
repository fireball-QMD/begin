...
! Program Declaration
! ===========================================================================
        subroutine readpsi_excite (nssh, filein, mesh_max, npoints, rrc,    &
     &                             drr, xnocc, rr, psi)
        use constants
        use precision
        implicit none
...
!Input
        ...
        character(len=12), intent(in), dimension (nssh) :: filein
...
! Open the input file
        do issh = 1, nssh
         open (unit = 21, file = filein(issh), status = 'old')
